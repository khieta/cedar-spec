...
theorem lub_comm2 {ty₁ ty₂ : CedarType} :
  (ty₁ ⊔ ty₂) = (ty₂ ⊔ ty₁)
:= by
  induction ty₁, ty₂ using lub?.induct
    (motive1 := fun qty₁ qty₂ =>
...
:= by
  ...
  case case1 ty₁ ty₂ IH qty₃ h1 h2 =>
    cases qty₃ <;> simp only [lubQualifiedType, Option.bind_eq_bind] at *
    simp only [Option.bind_eq_some, Option.some.injEq, and_imp, Qualified.optional.injEq, exists_eq_right] at *
    apply IH h1 h2
  case case2 ty₁ ty₂ IH qty₃ h1 h2 =>
    cases qty₃ <;> simp only [lubQualifiedType, Option.bind_eq_bind] at *
    simp only [Option.bind_eq_some, Option.some.injEq, and_imp, Qualified.required.injEq, exists_eq_right] at *
    apply IH h1 h2
  case case3 qty₁ qty₂ IH1 IH2 qty₃ h1 h2 =>
    cases qty₃ <;> simp only [lubQualifiedType] at *
  case case4 bt₁ bt₂ =>
    intro h1 h2
  ...
  case case5 ty₁ ty₂ IH =>
    ...
    simp only [Option.bind_eq_some, Option.some.injEq, and_imp, CedarType.set.injEq, exists_eq_right] at *
    apply IH h1 h2
  case case6 rty₁ rty₂ IH =>
    ...
    simp only [Option.bind_eq_some, Option.some.injEq, and_imp, CedarType.record.injEq, exists_eq_right, Map.mk.injEq] at *
    apply IH _ h1 h2
  ...
  case case11 k₁ v₁ r₁ k₂ v₂ r₂ heq IH1 IH2 rty₃ h1 h2 =>
    ...
    | (k₃, v₃) :: r₃ =>
      ...
      simp only [Option.bind_eq_some, Option.some.injEq, and_imp, CedarType.record.injEq, exists_eq_right, List.cons.injEq, Prod.mk.injEq, exists_eq_right_right] at *
      ...
      subst k₃
      simp [lubRecordType]
      simp only [lubRecordType, Option.bind_eq_some, Option.some.injEq, and_imp, CedarType.record.injEq, exists_eq_right, List.cons.injEq, Prod.mk.injEq, true_and, exists_eq_right_right] at *
      constructor
